...
function KillLogFrame_LoadData()
  ...
  chatParseInfo.template = COMBATLOG_XPGAIN_EXHAUSTION1_GROUP;
  ...
  chatParseInfo.template = ERR_ZONE_EXPLORED_XP;
  ...
  chatParseInfo.template = ERR_QUEST_REWARD_EXP_I;
  -- "Experience gained: %d."
  ...
  chatParseInfo.template = COMBATHITSELFOTHER;
  -- "You hit %s for %d."
  ...
  chatParseInfo.template = SPELLLOGSELFOTHER;
  -- "Your %s hits %s for %d."
  ...
  chatParseInfo.func = function(t) KillLogFrame_StoreTrivialCreepName(t.creepName); KillLogFrame_CheckMaxDamage(t.spell, KILLLOG_LABEL_HIT, t.damage, KILLLOG_LABEL_DAMAGE); end;
  chatParseInfo.template = SPELLLOGSCHOOLSELFOTHER;
  -- "Your %s hits %s for %d %s."
  ...
  chatParseInfo.template = COMBATHITOTHEROTHER;
  -- "%s hits %s for %d."
  ...
  chatParseInfo.template = COMBATHITCRITOTHEROTHER;
  -- "%s crits %s for %d."
  chatParseInfo.fields = { nil, "creepName", "damage" };
  ChatParse_RegisterEvent(chatParseInfo);
  -- #Endregion
  ...
  chatParseInfo.template = SPELLLOGSCHOOLOTHEROTHER;
  ...
  chatParseInfo.template = SPELLLOGCRITSCHOOLOTHEROTHER;
  ...
  chatParseInfo.template = COMBATHITOTHERSELF;
  -- "%s hits you for %d."
  chatParseInfo.fields = { "creepName", "damage" };
  ChatParse_RegisterEvent(chatParseInfo);

  chatParseInfo.func = function(t) KillLogFrame.lastHitOtherToSelf = t.creepName; end;
  chatParseInfo.template = COMBATHITCRITOTHERSELF;
  -- "%s crits you for %d."
  chatParseInfo.fields = { "creepName", "damage" };
  ChatParse_RegisterEvent(chatParseInfo);
  -- #Endregion
  ...
  chatParseInfo.func = function(t) KillLogFrame.lastHitOtherToSelf = t.creepName; end;
  chatParseInfo.template = SPELLLOGSCHOOLOTHERSELF;
  -- "%s's %s hits you for %d %s damage."
  chatParseInfo.fields = { "creepName", "spell", "damage", "spelltype" };
  ChatParse_RegisterEvent(chatParseInfo);

  chatParseInfo.func = function(t) KillLogFrame.lastHitOtherToSelf = t.creepName; end;
  chatParseInfo.template = SPELLLOGCRITSCHOOLOTHERSELF;
  ...
  chatParseInfo.template = UNITDIESOTHER;
  -- "%s dies."
  ...
  chatParseInfo.template = UNITDIESSELF;
  -- "You die."
